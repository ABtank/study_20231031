    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('hot', 'Горячее'), ('fresh', 'Свежее'), ('best', 'Лучшее')], max_length=20, verbose_name='Категории')),
        ...
        migrations.AddField(
            ...
            name='tags',
            field=models.ManyToManyField(blank=True, to='my_news.mytag', verbose_name='Теги'),
        ),
        migrations.CreateModel(
            name='MyViewCount',
            fields=[
